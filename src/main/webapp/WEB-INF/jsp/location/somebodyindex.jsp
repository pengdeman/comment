...
<div style="height: 30%; background-color: black; display: block;" id="peopleinfo"">
	<div style="width: 40%; height: 100%; float: left;">
		<img src="<%=basePath%>pic/slt${picUrl}" style="width: 80%; height: 80%; margin-top: 9%; margin-left: 8%;  -moz-border-radius: 10px;  
        -webkit-border-radius: 10px;  
        border-radius: 10px;">
	</div>
	<div style="width: 60%; height: 100%; float: right;">
		<table style="margin-top: 6%; color: white; width: 95%;">
		<tr>
			<td>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称</td>
...
<div>
	<marquee width="85%" behavior="scroll" direction="left" style="color: white; margin-top: 0.5%; float: left;">
		主页访客： ${sbinfo }
　　 </marquee>
	<a href="javascript:showhiden()" style="color: white; float: right;" id="syid">👆️</a>
</div>
